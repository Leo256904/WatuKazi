...
class AuthViewModel:ViewModel() {
    ...
    fun signup(name:String,email:String,contact:String,password:String,
        ...
        mAuth.createUserWithEmailAndPassword(email,password)
            .addOnCompleteListener { task->
                ...
                if (task.isSuccessful){
                    ...
                    val userData = UserModel(name = name,  email=email, contact = contact, password=password,userId=userId)
