...
import com.example.watukazi.workerViewModel
...
fun AddworkerScreen(navController: NavController){
    ...
    val productViewModel: WorkerViewModel = viewModel()
    ...
    Column(modifier = Modifier.fillMaxSize().padding(20.dp),
        ...
        OutlinedTextField(value = workername,
        ...
        OutlinedTextField(value = workerskill,
            ...
            modifier = Modifier.fillMaxWidth())
        OutlinedTextField(value = workerphonenumber,
            onValueChange = {newworkerphonenumber -> workerphonenumber=newworkerphonenumber},
            label = { Text(text = "Enter Worker Skill") },
            placeholder = { Text(text = "Please enter worker skill") },
            modifier = Modifier.fillMaxWidth())

        OutlinedTextField(value = workerrate,
        ...
        Row(modifier = Modifier.fillMaxWidth(),
            ...
            Button(onClick = {},colors = ButtonDefaults.buttonColors(Color.Black)) { Text(text = "HOME") }
            Button(onClick = {
                imageUri.value?.let {
